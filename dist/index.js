...
class Block {
    ...
    constructor(index, hash, previousHash, data, timestamp) {
        this.sayHello = () => { return "hello"; }; // test method
        this.index = index;
        this.hash = hash;
...
const genesisBlock = new Block(0, "2839472384234", "", "hello", 123456);
...
const getHasforBlock = (aBlock) => Block.calculateBlockHash(aBlock.index, aBlock.previousHash, aBlock.timestamp, aBlock.data);
